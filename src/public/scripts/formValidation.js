function validateForm() {
    ...
    if (round_numbers.length < 6 || round_numbers.length > 10) {
        ...
        for (let i = 0; i < round_numbers.length; i++) {
            ...
            if (!Number.isInteger(round_numbers[i])) {
                document.getElementById("numbersError").textContent = "Can only contain whole numbers.";
                valid = false;
                break;
            }
        }
